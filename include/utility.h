...
void append_to_string(char* i_OrigString, char* i_PartToAppend);
void append_int_to_string(char* i_OrigString, Uint i_Num);
char* concat_block(bitcoin_block_data* i_Block);
